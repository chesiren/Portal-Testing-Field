...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private Vector3 m_CameraSmoothVel;
        ...
        private void Start()
        {
            ...
            anim.Play("chell.qc_skeleton|a_idle");
        ...
        private void UpdateCameraPosition(float speed)
        {
            ...
            m_Camera.transform.localPosition = Vector3.SmoothDamp(m_Camera.transform.localPosition, newCameraPosition, ref m_CameraSmoothVel, 0.1f);
        }
